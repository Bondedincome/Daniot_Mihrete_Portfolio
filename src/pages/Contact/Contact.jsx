  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white font-inter pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-rose-500/10 to-purple-600/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="contact-form">
            <h2 className="text-2xl font-bold mb-6 font-poppins">Send a Message</h2>
          ...
          <div className="contact-info">
            <h2 className="text-2xl font-bold mb-6 font-poppins">Let's Connect</h2>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">hello@daniotmihrete.com</p>
                </div>
              </div>
            ...
            {/* Social Links */}
            <div>
              <h3 className="text-lg font-semibold mb-4 font-poppins">Follow Me</h3>
